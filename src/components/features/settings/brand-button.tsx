  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "primary" &&
          "border border-white/20 bg-primary text-[var(--oh-accent-foreground)] hover:bg-[#4a4a4a] hover:opacity-100 disabled:bg-[var(--oh-interactive-hover)] disabled:text-[var(--oh-muted)] disabled:opacity-100",
        variant === "secondary" &&
